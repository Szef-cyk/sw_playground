        ...
        <>
            <div className={styles.background} style={{ backgroundImage: `url(${boardBackground})` }}>
                <div className={styles.boardContainer}>
                    ...
                    <div className={styles.specialCard2}></div>
                    <div className={styles.cardTop1}></div>
                    <div className={styles.cardTop2}></div>
                    <div className={styles.cardBottom1}></div>
                    <div className={styles.cardBottom2}></div>
